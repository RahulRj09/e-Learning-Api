...
app.post('/courses/:id/exercises', (req, res, next) =>{
...
app.get('/courses/:cid/exercises/:eid', (req, res, next) =>{
    fs.readFile( __dirname + "/" + "exercise.json", 'utf8', (err, data) => {
        if(!err){
...
app.put('/courses/:cid/exercises/:eid', (req, res, next) =>{
    fs.readFile( __dirname + "/" + "exercise.json", 'utf8', (err, data) => {
        let coures_exercise = JSON.parse( data );
...
app.get('/courses/:cid/exercises/:eid/submissions', (req, res, next) =>{
